...
const passApi = async (params: any) =>
    post<any>({url: URL.pass, params: params, headers: {}});
const cancelUserOrderApi = async (params: any) =>
    post<any>({url: URL.cancelUserOrder, params: params, headers: {}});

export {listApi, userOrderListApi, createApi, updateApi, passApi, deleteApi, cancelApi, cancelUserOrderApi};
